...
$arPSCorrespondence = array(
		...
		"SELLER_RS" => array(
				...
				"DESCR" => "Расчетный счет компании-поставщика (продавца)",
				"VALUE" => "",
				"TYPE" => ""
			),
		"SELLER_BANK" => array(
				"NAME" => "Банк компании-поставщика",
				"DESCR" => "Банк компании-поставщика (продавца)",
				"VALUE" => "",
				"TYPE" => ""
			),	
		"SELLER_KS" => array(
				"NAME" => "Корреспондентский счет банка компании-поставщика",
				"DESCR" => "Корреспондентский счет банка компании-поставщика (продавца)",
				"VALUE" => "",
				"TYPE" => ""
			),
		"SELLER_BIK" => array(
		...
		"SELLER_NDS" => array(
				"NAME" => "НДС компании-поставщика",
				"DESCR" => "НДС компании-поставщика (продавца)",
				"VALUE" => "",
				"TYPE" => ""
			),
