...
<div class="catalog-section-list">
    <?
        ...
        <a href="javascript:get_submenu(<?=$arSection['ID']?>,false)">
            <?=$arSection["NAME"]?>
        ...
        {
            echo "</li>";
            echo "\n",str_repeat("\t", $CURRENT_DEPTH-$TOP_DEPTH),"<li><a href='/new_products/' class='new_products_link' titlt='Новые товары за последние 30 дней'>Новые товары</a></li></ul>","\n",str_repeat("\t", $CURRENT_DEPTH-$TOP_DEPTH-1);
            $CURRENT_DEPTH--;
        }
    ?>
</div>