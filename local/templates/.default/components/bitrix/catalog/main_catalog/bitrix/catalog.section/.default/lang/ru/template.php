...
$MESS["POPUP_WARNING"] = "Внимание";
$MESS["POPUP_MESSAGE"] = "Для просмотра остатков по складам, добавления в избранное и подписки на уведомление о поступлении <b>нажмите на значок</b>";
$MESS["POPUP_BUTTON_MESSAGE"] = "Больше не показывать";
?>