...
$(function(){
    $("form[name=regform]").submit(function(){
        ...
        console.log(email);
        $(this).find("input#LOGIN").val(email);        
    });
})
...
?>
<input type="hidden" name="REGISTER[LOGIN]" value="<?=$arResult["VALUES"]["LOGIN"]?>" id="LOGIN"/>

<table class="retail-reg">
	<tbody>
...
<?
		...
		default:
			...
			?><input size="30" type="text" name="REGISTER[<?=$FIELD?>]" value="<?=$arResult["VALUES"][$FIELD]?>" id="<?=$FIELD?>"/><?
...
?>
	...
	<tfoot>
		<tr>
			<th colspan="2">
                <div class="field">
                    <font class="red-text">*</font> - <?=GetMessage("AUTH_REQ")?><br>
                    <?echo $arResult["GROUP_POLICY"]["PASSWORD_REQUIREMENTS"];?>
                </div>
                <input type="submit" class="button2" name="register_submit_button" value="<?=GetMessage("AUTH_REGISTER")?>" />
            </th>
		</tr>
	</tfoot>
</table>
