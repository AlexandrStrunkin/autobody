...
<thead><tr><td colspan="2" class="subcriptionTitle"><?echo GetMessage("subscr_title_auth")?></td></tr></thead>
<tr>
	<td class="subcriptionFirsttd">       
        <?echo GetMessage("adm_auth_user")?>
		<span class="subcriptionAuthUserLogin"><?echo htmlspecialcharsbx($USER->GetFormattedName(false));?> [<?echo htmlspecialcharsbx($USER->GetLogin())?>].</span> 
	</td>
