...
$MESS ['subscr_conf_date'] = "Дата генерации кода";
$MESS ['subscr_conf_send'] = "Запросить код*";
...
$MESS ['subscr_title_confirm'] = "Подтверждение: ";
$MESS ['subscr_conf_note1'] = "Если вы еще не получили письмо с кодом подтверждения, вы можете";
$MESS ['subscr_conf_note2'] = "повторно запросить код!";
...
$MESS ['subscr_title_status_note_error1'] = "Ваша подписка не подтверждена. ";
$MESS ['subscr_title_status_note_error2'] = "Чтобы подтвердить подписку, введите код подтверждения в форме выше.";
