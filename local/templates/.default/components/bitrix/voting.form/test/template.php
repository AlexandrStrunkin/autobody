...
<div class="voting-form-box">
    <form action="/vote_results.php" method="post" class="vote-form">
            ...
            <?
                ...
                <li class="vote-item-vote <?=($iCount == 1 ? "vote-item-vote-first " : "")?><?
                    ...
                    <div class="vote-item-header">
                        ...
                        ?>
                        <div class="vote-item-title vote-item-question left-vote-title"><?=$arQuestion["QUESTION"]?><?if($arQuestion["REQUIRED"]=="Y"){echo "<span class='starrequired'>*</span>";}?></div>
                                ...
                                <?
                                    ...
                                    <span class="vote-answer-item vote-answer-item-radio">
                                        <label class="custom-radio-wh">
                                            ...
                                            <div for="vote_radio_<?=$arAnswer["QUESTION_ID"]?>_<?=$arAnswer["ID"]?>"><?=$arAnswer["MESSAGE"]?></div>
                                        </label>                                         
                                    </span>
                                    <?
                                        break;
        ...
        <div class="vote-form-box-buttons vote-vote-footer">
            <span class="vote-form-box-button vote-form-box-button-first"><input class="vote-button" type="submit" name="vote" value="<?=GetMessage("VOTE_SUBMIT_BUTTON")?>" /></span>
