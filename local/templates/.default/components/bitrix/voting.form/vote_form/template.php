<?if (!defined("B_PROLOG_INCLUDED") || B_PROLOG_INCLUDED!==true)die();
   ...
   // $vote_id = $arResult["VOTE"]["ID"];
    //проверяем, участвовал ли данный пользователь в опросе

   //echo IsUserVoted($arResult["VOTE"]);
    if ($_REQUEST["VOTE_ID"] or IsUserVoted($arResult["VOTE"]['ID']) == true){
       // if ($_REQUEST["VOTE_ID"]) {header("location: ".$_SERVER["REQUEST_URI"]);}
        ?>
