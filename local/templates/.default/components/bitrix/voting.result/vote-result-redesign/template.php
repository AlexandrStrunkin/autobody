...
?>
			<div class="vote-item-title vote-item-question left-vote-title"> <?=$arQuestion["QUESTION"]?></div>
            <div class="left-vote-note">Поделитесь Вашим <br> мнением с нами, <br> участвуйте в опросе!</div>
...
?>
			...
			<?foreach ($arQuestion["ANSWERS"] as $arAnswer):?>
				<tr><? if (isset($arResult['GROUP_ANSWERS'][$arAnswer['ID']])):?> </tr>
				...
				<tr>
					...
					&nbsp;</td></tr>
                    <tr>
					<td><div class="vote-answer-bar" style="width:<?=$percent?>%;background-color:#A29D97"></div>
