...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
<tr>
<td><nobr>Товаров в категории: <b><?=$arResult['TOTAL_COUNT']?></b>, &nbsp; </nobr> &nbsp;<nobr>  
<?$APPLICATION->IncludeFile("page_nav_grid.php", Array('ON_PAGE'=>$arParams['ON_PAGE'], 'TOTAL'=>$arResult['TOTAL']));?></nobr></td>
<noindex>
...
?>">OEM#<?if($_REQUEST['sort_by']=='PROPERTY_UNC'){
if($_REQUEST['sort_as']=='asc') echo ' ▼'; else echo ' ▲';
}?></a></td>
<td class="goodstop">Год</a></td>
<td nowrap width=100% align=left class="goodstop"><a href="<?
...
<td class="goods" nowrap><?=$arItem['PROPS']['UNC']['VALUE']?></td> 
<td class="goods" nowrap><?=$arItem['PROPS']['SIZE']['VALUE']?></td> 
<td align=left class=goods><b><a href="<?=$arItem['DETAIL_PAGE_URL']?>"><?=substr($arItem['NAME'],0)?></a></b><br></td> 
...
<?else:?>
<div style="padding:10px!important;">Товары в данной группе отстутствуют!</div>
<?endif;?>
