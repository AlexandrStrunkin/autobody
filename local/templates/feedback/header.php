...
<head>
    ...
    <script type="text/javascript" charset="utf-8">
        $(function(){
            $('#wh_mail').SumoSelect({placeholder: 'Выберите адрес для отправки',selectAll: true});
        });
    </script>
...
if($USER->IsAuthorized()){
    $APPLICATION->IncludeFile(SITE_DIR."include/admin_popup.php", Array(),Array("MODE"=>"html"));  
}?>
