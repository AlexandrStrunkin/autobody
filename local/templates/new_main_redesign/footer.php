...
<div class="div-footer">
  ...
  <?if (checkSite()=="retail") 
    {
        $APPLICATION->IncludeFile(SITE_DIR."/include/main_footer_text_retail.php", Array(),Array("MODE"=>"html"));    
    }
    else
    {
        $APPLICATION->IncludeFile(SITE_DIR."/include/main_footer_text_opt.php", Array(),Array("MODE"=>"html"));    
    }
   ?>
 ...
 <p>«© 2007-<?=date("Y")?> Форвард – интернет магазин автозапчастей,<br> склад автозапчастей в Москве, автозапчасти оптом от производителей»</p>
